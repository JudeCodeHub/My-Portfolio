      ...
      <div className="container max-w-4xl mx-auto text-center z-10 mt-16">
        <div className="space-y-6">
          ...
          <div className="pt-14 flex justify-center opacity-0 animate-fade-in-delay-3">
            <a
              href="#projects"
              className="px-6 py-2.5 text-sm rounded-full border border-sky-400/50 bg-transparent text-sky-400 font-medium transition-all duration-300 hover:border-sky-300 hover:bg-sky-400/10 hover:shadow-[0_0_20px_rgba(56,189,248,0.5)] active:scale-95 flex items-center justify-center gap-2 group"
            >
