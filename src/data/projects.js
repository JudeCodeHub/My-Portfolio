// Canonical project list — single source of truth, consumed by both the
// Projects section UI (ProjectSection.jsx, which only reads title/image/
// terminalName/link fields) and the AI chat's knowledge base (about-me.js,
// which reads everything, including highlights/tech, to answer detailed
// project questions). Edit here; both consumers pick up changes
// automatically. Order matches the intended display order (1-9).
...
export const PROJECTS = [
  {
    ...
    // This infographic needs to stay centered on narrow mobile cards (the
    // default top-left anchor crops off the right side, cutting into the
    // AWS EKS diagram) — desktop already looks right with the default.
