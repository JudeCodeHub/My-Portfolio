...
const fadeUpSlow = (delay = 0) => ({
  ...
  visible: {
    opacity: 1,
    y: 0,
    transition: { duration: 1.4, ease: [0.25, 1, 0.5, 1] as const, delay },
  },
});
...
export const AboutSection = () => {
  return (
    <section
      id="about"
      className="relative min-h-screen pt-20 lg:pt-16 pb-16 lg:pb-8 px-4 overflow-hidden flex flex-col justify-center lg:items-center scroll-mt-12 lg:scroll-mt-18 md:ml-10"
    >
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 lg:gap-16 mb-8 md:mb-6 lg:mb-2 mt-0 md:mt-4 lg:mt-6">
          <div className="hidden md:block md:col-span-5"></div>

          <motion.div
            variants={fadeUp(0.1)}
            className="md:col-span-7 text-center md:text-left md:-ml-8 lg:-ml-16"
          >
            <h2 className="text-3xl md:text-5xl font-mono font-bold text-foreground dark:text-white tracking-tight flex gap-3 justify-center md:justify-start items-center">
        ...
        <motion.div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-8 lg:gap-16 items-center mb-8 md:mb-12 lg:mb-6 mt-0">
          <motion.div
            variants={fadeUp(0.2)}
            className="md:col-span-5 flex justify-center items-center relative mt-2 md:mt-4 lg:-mt-4"
          >
            <div className="relative w-[200px] h-[200px] md:w-70 md:h-70 lg:w-[340px] lg:h-[340px]">
          ...
          <motion.div
            variants={fadeUp(0.4)}
            className="md:col-span-7 flex flex-col justify-center text-center md:text-left mt-6 md:mt-0 md:-ml-8 lg:-ml-16"
          >
            ...
            <div className="text-slate-700 dark:text-white/80 text-sm md:text-lg leading-relaxed md:leading-loose max-w-2xl mx-auto md:mx-0 font-medium dark:font-light tracking-wide text-justify">
              <p>
                ...
                full-stack apps with React and Next.js, then deploy and automate
                them with Docker, Kubernetes, and Terraform. Clean on the front
                end, solid underneath, and that&apos;s the goal every time.
              </p>
            </div>
                ...
                onClick={(e) => {
                  if (window.innerWidth >= 768) {
                    ...
                    window.dispatchEvent(
                      new CustomEvent("navigateSection", { detail: "contact" }),
                    );
                  }
                }}
