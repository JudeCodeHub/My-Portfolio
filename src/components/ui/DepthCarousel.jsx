          ...
          >
            ...
            {item.badge && (
              <div className="absolute top-4 right-4 z-20 pointer-events-none">
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] md:text-xs font-bold tracking-wide uppercase shadow-xl bg-orange-500 text-white">
                  {item.icon}
                  {item.badge}
                </span>
              </div>
